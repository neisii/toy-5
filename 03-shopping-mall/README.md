...
### 2. 검색 기능 - "맥북" 검색 결과
![검색 기능](docs/images/02-search-macbook.png)

### 3. 카테고리 필터링 - 전자제품
![카테고리 필터](docs/images/03-filter-electronics.png)

### 4. 장바구니 추가 Toast 알림
![Toast 알림](docs/images/04-add-to-cart-toast.png)

### 5. 장바구니 아이콘 배지 (2개)
![장바구니 배지](docs/images/05-cart-badge.png)

### 6. 장바구니 페이지
![장바구니 페이지](docs/images/06-cart-page.png)

### 7. 장바구니 수량 조절
![수량 조절](docs/images/07-cart-quantity.png)

### 8. 페이지네이션
![페이지네이션](docs/images/08-pagination.png)

### 9. 검색 + 카테고리 조합 필터
![조합 필터](docs/images/09-combined-filter.png)

### 10. 모바일 반응형 화면
![모바일 뷰](docs/images/10-mobile-view.png)
